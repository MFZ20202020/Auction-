...
form.addEventListener('submit', (e)=> {
    ...
    if (password_repeat.value == null || password_repeat.value == "")
          {
               e.preventDefault();
              repeat_error.innerHTML = "أدخل كلمة مرورك";
              password_repeat.style.borderColor = "red";
      }
    else if ( password_repeat.value !== password.value)
          {
               e.preventDefault();
              repeat_error.innerHTML = "كلمة مرورك غير متطابقة";
              password_repeat.style.borderColor = "red";
      }
    else{
        repeat_error.innerHTML = " ";
        password_repeat.style.borderColor = "black";
    }
